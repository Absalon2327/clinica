                                ...
                                <div class="col-xxl">
                                    <div class="card mb-4">
                                        <div class="card-header">
                                            <h3 class="card-title" id="nombre_paciente" name="nombre_paciente">Nuevo Expediente - </h3>
                                        ...
                                        <div class="card-body">
                                            <div class="col-12">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-sm-12">
                                                        <div class="input-group">
                                                            <textarea id="padecimiento_actual" name="padecimiento_actual" class="form-control" placeholder="..." aria-label="..." required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="col-12">
                                                <div class="row mb-3">
                                                    <div class="col-sm-6">
                                                        <h6 class="mb-0">
                                                            <strong>APARATOS Y SISTEMAS: </strong>
                                                        </h6>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-sm-12">
                                                        <div class="input-group">
                                                            <textarea id="aparatos_sistemas" name="aparatos_sistemas" class="form-control" placeholder="..." aria-label="..." required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="col-12">
                                                <div class="row mb-3">
                                                    <div class="col-sm-6">
                                                        <h6 class="mb-0">
                                                            <strong>AUXILIARES DE DIAGNÓSTICO PREVIO: </strong>
                                                        </h6>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-sm-12">
                                                        <div class="input-group">
                                                            <textarea id="auxiliares_diagnostico_previo" name="auxiliares_diagnostico_previo" class="form-control" placeholder="..." aria-label="..." required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
