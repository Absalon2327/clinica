...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default  Mostrando _START_ a _END_ de_TOTAL_ registros
			 *
			 *  @dtopt Language
			 ...
			 *  @type string
			 *  @default Mostrar_MENU_ registros
			 *
			 *  @dtopt Language
			 ...
			 *  @type string
			 *  @default No se encontraron resgistros 
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sZeroRecords": "No se encontraron resgistros "
		},
